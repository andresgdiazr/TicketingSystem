...
const Home = () => {
	...
	return (
		<div className="relative w-full h-screen">
			...
			<div className='absolute top-44 left-48 flex flex-col'>
				<h2 className="m-0 font-extrabold text-8xl text-gray-800">Bienvenido al</h2>
				<h2 className="m-0 font-extrabold text-8xl text-gray-800">Sistema de boletería de</h2>
				<h2 className="m-0 font-extrabold text-8xl text-fuchsia-700"> 
				<span className='font-extrabold text-8xl text-gray-800'>Funk </span>
				<span  className='font-extrabold text-8xl text-gray-800'>Up </span>
				Dance Studio</h2>
